...
export default function CardComponentParaJogar({ id, name, hours_expected, platform, genre, is_completed, release_year, status, priority, background_image, deletajooj }: dadosJogos) {
    ...
    return (
        <Card className='w-full h-[500px] gap-2 flex flex-col items-start cursor-pointer border-2 hover:border-4 border-white/50 hover:border-amber-500 transition-all bg-slate-900 shadow-4xl' key={id}>
            ...
            <div className="absolute bg-black/20 z-10  rounded-lg shadow-lg  hover:bg-gray-600">
                ...
                <AttGameModalParaJogar gameId={id} data={{ id, name, hours_expected, platform, genre, is_completed, release_year, status, priority, background_image }} />
            </div>
